...
public class Packet : IDisposable
{
    ...
    public string ReadString(bool _moveReadPos = true)
    {
        ...
        {
            int _length =
                ReadInt() * 2; // Get the length of the string ,Unicode编码无论中文英文都是2字节，比如欢迎应该是4字节，欢迎字数是2，length就是字数*2
            string _value =
                Encoding.Unicode.GetString(readableBuffer, readPos, _length); // Convert the bytes to a string
